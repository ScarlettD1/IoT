...
from .views import humidity_chart, illuminance_chart, moisture_chart, temperature_chart, add_sensor_reading, get_fan_speed, get_watering_state
...
urlpatterns = [
    ...
    path('api/hood-speed/', get_fan_speed, name='get_fan_speed'),
